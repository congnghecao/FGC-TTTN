                ...
                <div class="tile">
                    <div class="tile-body">
                        <div id="sampleTable_wrapper"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="hoten" autocomplete="true"
                                                                           class="form-control"
                                                                           type="text"
                                                                           placeholder="VD: Nguyễn Xuân Hạnh"
                                                                           name="hoten">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <span class="erro pl-1">*</span>
                                                                    <textarea class="form-control" rows="1" name="ntt"
                            ...
                            @endif
                            @if(session('thongbao'))
                                <div class="text-center alert alert-success mb-1 mt-1 p-11">
                                    {{session('thongbao')}}
                                </div>
                            @endif
                            <div class="row">
                                                        ...
                                                        <div class="collapse navbar-collapse"
                                                            ...
                                                            <ul class="navbar-nav ml-auto mr-auto">
                                                                ...
                                                                <span class="btn badge badge-pill badge-dark chi-tiet"
                                                                      ...
                                                                      aria-expanded="false" title="Chi tiết">@</span>
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="btn btn-suaNS badge badge-warning"
                                                                       value="{{$ns->id}}" title="Sửa">Sửa</a>
                                                                </li>
                                                                @if(Auth::user()->name === 'Admin')
                                                                    <li class="nav-item">
                                                                        <a href="admin/nhansu/xoa/{{$ns->id}}" title="Xóa"
