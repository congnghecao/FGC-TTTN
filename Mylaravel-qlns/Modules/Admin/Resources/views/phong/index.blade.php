                            ...
                            <div class="col-sm-12">
                                <table class="table table-hover table-bordered dataTable no-footer" id="sampleTable"
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>{{$pb->mo_ta}}</td>
                                        <td>
                                            <button data-catid="{{$pb->id}}" data-mytitle="{{$pb->ten_phong}}" data-mydescriptiton="{{$pb->mo_ta}}" class="btn btn-primary" style="color: white;font-size: 10px;border: 20px;" type="button" data-toggle="modal" data-target="#edit">Cập nhật</button>
                                            <a href="{{route('admin.get.delete.phong',$pb->id)}}" style="color: white;font-size: 10px;border: 20px;" class="btn btn-danger" type="button">Xóa</a>
                                        </td>
                                    </tr>
                                        @endforeach
