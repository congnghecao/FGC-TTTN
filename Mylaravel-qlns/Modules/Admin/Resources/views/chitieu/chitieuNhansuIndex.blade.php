    ...
    <main class="app-content">
        <div class="app-title">
            <div class="row">
                ...
                <div class="col-md-3">
                    <a href="{{route('admin.get.danhsachchitieunhansuCreate.chitieu')}}" class="btn btn-primary" style="border-radius: 10px;" type="button">Thêm Mới</a>
                </div>
                                        ...
                                        @foreach($chitieuchitieu as $ctct)
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    ...
                                                    <button data-idid="{{$ctct->id}}" data-idchitieu="{{$ctct->id_chi_tieu}}" data-idnhansu="{{$ctct->id_nhan_su}}" data-diemct="{{$ctct->diem_chi_tieu}}"
                                                            data-diemdd="{{$ctct->diem_dat_duoc}}" data-khenthuong="{{$ctct->khen_thuong}}" data-thag="{{$ctct->thang}}" data-namm="{{$ctct->nam}}" data-canhbao="{{$ctct->canh_bao}}"
                                                            class="btn btn-primary" style="color: white;font-size: 10px;border: 20px;" type="button" data-toggle="modal" data-target="#chitieuNhansu">Cập nhật</button>
                                                    <a href="{{route('admin.get.delete.chitieu',$ctct->id)}}" style="color: white;font-size: 10px;border: 20px;" class="btn btn-danger" type="button">Xóa</a>
                                                </td>
                                            </tr>
                                        @endforeach
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <div class="dataTables_paginate paging_simple_numbers" id="sampleTable_paginate">
                                        <ul class="pagination">
                                            <li class="paginate_button page-item active" style="margin-left: 10px;">{{$chitieuchitieu->links()}}</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body pd" style="margin: 20px;">
                                            ...
                                            <form action="{{route('admin.get.danhsachchitieunhansuUpdate.chitieu')}}" method="post" onchange="thuchien()">
